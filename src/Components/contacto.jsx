...
const Contacto = () => {
    const handleSubmit = () => {
        alert('Esta opción está en desarrollo, puedes ponerte en contacto conmigo a través de mi correo electrónico o LinkedIn.');
    };
    ...
    return (
        ...
        <form className='border py-4 rounded-md border-zinc-400 px-6 mt-10'>
            ...
            <label htmlFor='subject' className='text-zinc-100 text-2xl'>Asunto</label>
            <input type='text' id='subject' placeholder='Asunto' className='w-full p-2 rounded-md mb-8 bg-zinc-900 border-2 border-zinc-400 text-zinc-100'></input>
            ...
            <button 
                ...
                className='w-1/3 mx-auto justify-center flex my-3 p-2 rounded-md bg-zinc-900 border-2 border-zinc-400 text-zinc-100 hover:bg-zinc-800 hover:border-zinc-500 transition-all duration-300'
            >
                Enviar
            </button>
        </form>
